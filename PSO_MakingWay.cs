...
public class PSO_MakingWay : MonoBehaviour
{
    int fixedUpdate = 0;
    int unityUpdate = 0;
    ...
    void resetLeaders()
    {
        ...
        Debug.LogWarning("Leaders reset");
    }
    ...
    void resetSwarm()
    {
        ...
        Debug.LogWarning("Followers reset");
    }
